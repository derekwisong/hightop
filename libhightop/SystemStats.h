...
namespace hightop {
  class SystemStats {
    ...
    double get_load_1_min() const { return load_1_min; }
    double get_load_5_min() const { return load_5_min; }
    double get_load_15_min() const { return load_15_min; }
  ...
  int get_idle_time() const { return idle_time; }
    ...
    double load_1_min; // load average over the last minute
    double load_5_min; // load average over the last 5 minutes
    double load_15_min; // load average over the last 15 minutes
